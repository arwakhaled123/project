...
export default function Courses() {
  ...
  // const handleSavecourse = (updatedcourseData) => {
  //   if (Array.isArray(courses)) {
  //     setcourses(courses.map(course => 
  //       course.id === selectedcourse.id 
  //         ? { ...course, name: updatedcourseData.name, email: updatedcourseData.email } 
  //         : course
  //     ));
  //   }
  ...
  return <>
    <Row>
      ...
      {/* <Table className='table-headd' size="sm">
        <thead >
          <tr >
            <th className='roww'>Course Name</th>
            <th className='roww'>Status</th>
            <th className='roww'>Actions</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td><ol><li><img className='card_imgg' src={img} /><Card.Title className='card_titlee'>UI Design Principles</Card.Title></li></ol></td>
            <td className='col-txt'>Published</td>
            <td>
              <Dropdown>
                <Dropdown.Toggle className='action' >
      ...
      <div className="users-table">
          ...
          {courses.map(course => (
            <div className="course-row" key={course.id}>
              ...
              <div className="header-col courses-col">{course.status}</div>
            <div className="header-col actions-col">
                ...
                {actionMenuOpen === course.id && (
                  <div className="action-menu">
                    <button onClick={() => handleEditcourse(course)} id="btn_mng_course"> Edit  </button>
