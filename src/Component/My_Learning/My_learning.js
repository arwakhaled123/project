...
function My_learning() {
  ...
  return (
    <>
      ...
      <Row className="btns">
        <button className="btn-progress"><Link id="btn-progress-txt" to="/My-learning"><p id="btn-progress-txt">In Progress</p></Link></button>
        <button className="btn-complete"><Link id="btn-complete-txt" to="/My-learning2"><p id="btn-complete-txt">Complete</p></Link></button>
      </Row>
      {courses.map((course) => (
