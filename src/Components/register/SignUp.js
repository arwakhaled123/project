...
//       e.preventDefault();
//       console.log(lname,fname, email, phone,password,confirmpassword,terms);
//     };
...
//       <Row>
//         <Col>
//         <img src={image} alt="sign up" className=" object-cover" id='imgcover'/>   
...
//             <Row className='lableandcol'>
//              <form onSubmit={handleSubmit} >
//             <Row  xs="auto" md={1}>
//              <Col> <label  htmlFor="fname">First Name</label></Col>
//              <Col> <input type="text" id="fname" value={fname} onChange={(e) => setName(e.target.value)}  /> </Col>
            
//             <Col> <label  htmlFor="lname">Last Name</label></Col>
//             <Col><input type="text" id="fname" value={lname} onChange={(e) => setLName(e.target.value)}  /></Col>
//             </Row>

//             <Row>
//             <Col> <label  htmlFor="phone">Phone Number</label></Col>
//             <Col>  <input type="text" id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} /></Col>
            
//             <Col> <label  htmlFor="email">Email</label></Col>
//             <Col><input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)}  /></Col>
//              </Row>

//              <Row>
//              <Col> <label  htmlFor="password">Password</label><input type="password" id="password" value={password} onChange={(e) => setPassword(e.target.value)} /></Col>
             
//              <Col>  <label  htmlFor="confirmpassword">Confirm Password</label>  <input type="password" id="confirmpassword" value={confirmpassword} onChange={(e) => setConfirmPassword(e.target.value)}  /></Col>
//               </Row>
